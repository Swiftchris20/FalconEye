...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.aboutButton.setOnClickListener {
            startActivity(Intent(this, AboutXalconEyeActivity::class.java))
        }
        ...
        emotionClassifier = PyTorchClassifier.fromAsset(this, "resnet50_speed.pt")
    ...
    private fun appendPredictionToLog(prediction: String) {
        ...
        val logFile = File(docDir, "XalconEye_Predictions_Log.txt")
    ...
    private fun getProcessedImageOutputPath(): String {
        ...
        val roEmotionDir = File(picturesDir, "Exported Lines from XalconEye")
